...
const dishId = getQueryParam("dish");

// Populate the content if the dish exists
if (dishes[dishId]) {
  ...
  // Display an error message if the dish is not found
  document.body.innerHTML = "<h1>Dish not found</h1>";
}
